...
<table summary="" cellpadding="0" cellspacing="0" border="0" class="contentPage" width="95%" height="100%" >
	<html:form styleId="LabActivitiesSearchResultForm" action="<%="/LabActivitiesDB"%>" target="_self" >
						...
						<td>
							<table summary="" cellpadding="0" cellspacing="0" border="0" width="100%">
								<logic:present name="<%=DisplayConstants.SEARCH_RESULT%>">
									...
									<tr>
										<td>
										<display:table name="${SEARCH_RESULT.searchResultObjects}" sort="list" cellspacing="0" cellpadding="3"
			               pagesize="15" id="labtable" export="true" 
			               size="totalLabs" 
			               defaultsort="5" defaultorder="ascending"
                        requestURI=""
	    ...
	    style="border: 1px solid black; margin-top: 1em; margin-bottom: 1em; width: 100%;" class="dataTable">    
           ...
           <display:setProperty name="paging.banner.item_name" value="Lab Results" />               
           <display:setProperty name="paging.banner.items_name" value="Lab Results" />    
           ...
           <display:column  class="dataCellText" sortable="true" title="<img src='images/CheckBox.gif' alt='Select All' id='CheckGif' onclick='SelectAll();return false'/>'" maxLength="90">
                <html:multibox style="formFieldSized" property="recordIds" value="${labtable.recordId}"></html:multibox>
           </display:column>
           <display:column property="patientId"  class="dataCellText" sortable="true" title="Patient Id" maxLength="90"/>
           <display:column property="siteId"  class="dataCellText" sortable="true" title="Site" maxLength="200"/>
           <display:column property="date" class="dataCellText" sortable="true" title="Date / Time" />        
           <display:column property="labTestId"  class="dataCellText" sortable="true" title="Lab Test"  />
           <display:column property="textResult"  class="dataCellText" sortable="true" title="Text Result"  />
           <logic:equal name="labtable" property="isAdverseEvent" value="YES">
             <display:column property="numericResult"  class="dataCellTextRed" sortable="true" title="Numeric Result"  />
            </logic:equal>  
           <logic:notEqual name="labtable" property="isAdverseEvent" value="YES">
             <display:column property="numericResult"  class="dataCellText" sortable="true" title="Numeric Result"  />
           </logic:notEqual> 
           <display:column property="unitOfMeasure"  class="dataCellText" sortable="true" title="Unit Of Measure"  />
           <display:column property="lowRange"  class="dataCellText" sortable="true" title="Lower Limit"  />
           <display:column property="highRange"  class="dataCellText" sortable="true" title="Upper Limit"  />
           <logic:equal name="labtable" property="labLoadedToCDMS" value="true">
           <display:column property="labLoadedToCDMSDate"  class="dataCellText" sortable="true" title="Sent to CDMS"  />
           </logic:equal>
           <logic:notEqual name="labtable" property="labLoadedToCDMS" value="true">
	              <display:column property="labLoadedToCDMS"  class="dataCellText" sortable="true" title="Sent to CDMS"  />
           </logic:notEqual>
            <logic:equal name="labtable" property="adverseEventReported" value="true">
             <display:column property="adverseEventReportedDate"  class="dataCellText" sortable="true" title="Sent to caAERS"  />
            </logic:equal>
           <logic:notEqual name="labtable" property="adverseEventReported" value="true"> 
           <display:column property="adverseEventReported"  class="dataCellText" sortable="true" title="Sent to caAERS"  />
          </logic:notEqual>
