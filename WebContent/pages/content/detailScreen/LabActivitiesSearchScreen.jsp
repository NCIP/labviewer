																										...
																										<tr>
																											<th class="dataTableHeader" scope="col"
																												...
																												<a href="javascript:SelectAll();"> <img
																														id="CheckGif" src="images/CheckBox.gif"
																														border="0" alt="Select All"> </a>
																											</th>
																											<th class="dataTableHeader" scope="col"
													...
													-->
																											...
																											<tr class="dataRowLight">
																												<td class="dataCellNumerical" width="9%">
																													<html:multibox style="formFieldSized"
																														property="recordIds"
																														value="<%=searchResultObject.getRecordId()%>"></html:multibox>
																												</td>
																												<td class="dataCellText" width="9%">
																													<bean:write name="searchResultObject"
																														property="patientId" />
																													&nbsp;
																												</td>
																												<td class="dataCellText" width="9%">
																												...
																												<logic:equal name="searchResultObject"
																													property="isAdverseEvent"
																													value="<%=DisplayConstants.YES%>">
																													<td class="dataCellText" width="9%"
																														bgcolor="#ffiooo">
																														<bean:write name="searchResultObject"
																															property="numericResult" />
																														&nbsp;
																													</td>
																												</logic:equal>
																												<logic:notEqual name="searchResultObject"
																													property="isAdverseEvent"
																													value="<%=DisplayConstants.YES%>">
																													<td class="dataCellText" width="9%">
																														<bean:write name="searchResultObject"
																												...
																												<logic:equal name="searchResultObject"
																													property="labLoadedToCDMS" value="true">
																													<td class="dataCellText" width="9%"
																														bgcolor="silver">
																														<bean:write name="searchResultObject"
																															property="labLoadedToCDMSDate" />
																														&nbsp;
																													</td>
																												</logic:equal>
																												<logic:notEqual name="searchResultObject"
																													...
																													<td class="dataCellText" width="9%">
																														<bean:write name="searchResultObject"
																															property="labLoadedToCDMS" />
																														&nbsp;
																													</td>
																												</logic:notEqual>
																												<logic:equal name="searchResultObject"
																													property="adverseEventReported"
																													value="true">
																													<td class="dataCellText" width="9%"
																														bgcolor="silver">
																														<bean:write name="searchResultObject"
														...
														<logic:equal name="searchResultObject" property="adverseEventReported" value="<%="0"%>">
															<td class="dataCellText" width="15%">
																<html:button style="actionButton" property="adverseEventReported" onclick="<%="submitAdverseEvent('"
							+ searchResultObject.getRecordId() + "');"%>">Submit</html:button>
															</td>
														</logic:equal>
																								...
																								<table cellpadding="4" cellspacing="0"
																									...
																									<tr>
																										...
																										<td>
																											<html:button style="actionButton"
																												property="saveToCSV"
																												onclick="setAndSubmit('saveToCSV');">Save Labs to CSV</html:button>
																										</td>
																									</tr>
																								</table>
																								<!-- action buttons end -->
