...
public class Study  implements java.io.Serializable {
    ...
    private gov.nih.nci.cabig.ccts.domain.StudyDataEntryStatusType dataEntryStatus;
    private gov.nih.nci.cabig.ccts.domain.CoordinatingCenterStudyStatusType coordinatingCenterStudyStatus;
    ...
    private gov.nih.nci.cabig.ccts.domain.StudyOrganizationType[] studyOrganization;
    ...
    public Study(
           ...
           gov.nih.nci.cabig.ccts.domain.CoordinatingCenterStudyStatusType coordinatingCenterStudyStatus,
           gov.nih.nci.cabig.ccts.domain.StudyDataEntryStatusType dataEntryStatus,
           ...
           gov.nih.nci.cabig.ccts.domain.StudyOrganizationType[] studyOrganization,
     ...
     */
    public gov.nih.nci.cabig.ccts.domain.StudyDataEntryStatusType getDataEntryStatus() {
        return dataEntryStatus;
    }
     ...
     */
    public void setDataEntryStatus(gov.nih.nci.cabig.ccts.domain.StudyDataEntryStatusType dataEntryStatus) {
        this.dataEntryStatus = dataEntryStatus;
    }
     ...
     */
    public gov.nih.nci.cabig.ccts.domain.CoordinatingCenterStudyStatusType getCoordinatingCenterStudyStatus() {
        return coordinatingCenterStudyStatus;
    }
     ...
     */
    public void setCoordinatingCenterStudyStatus(gov.nih.nci.cabig.ccts.domain.CoordinatingCenterStudyStatusType coordinatingCenterStudyStatus) {
        this.coordinatingCenterStudyStatus = coordinatingCenterStudyStatus;
    }
    ...
    public gov.nih.nci.cabig.ccts.domain.EpochType getEpoch(int i) {
        return this.epoch[i];
    }

    public void setEpoch(int i, gov.nih.nci.cabig.ccts.domain.EpochType _value) {
        this.epoch[i] = _value;
    }
     ...
     */
    public gov.nih.nci.cabig.ccts.domain.StudyOrganizationType[] getStudyOrganization() {
        return studyOrganization;
    }
     ...
     */
    public void setStudyOrganization(gov.nih.nci.cabig.ccts.domain.StudyOrganizationType[] studyOrganization) {
        this.studyOrganization = studyOrganization;
    }

    public gov.nih.nci.cabig.ccts.domain.StudyOrganizationType getStudyOrganization(int i) {
        return this.studyOrganization[i];
    }

    public void setStudyOrganization(int i, gov.nih.nci.cabig.ccts.domain.StudyOrganizationType _value) {
