...
public class StratificationCriterionType  implements java.io.Serializable {
    ...
    private gov.nih.nci.cabig.ccts.domain.StratificationCriterionPermissibleAnswerType[] permissibleAnswer;

    public StratificationCriterionType() {
    }

    public StratificationCriterionType(
           gov.nih.nci.cabig.ccts.domain.StratificationCriterionPermissibleAnswerType[] permissibleAnswer,
     ...
     */
    public gov.nih.nci.cabig.ccts.domain.StratificationCriterionPermissibleAnswerType[] getPermissibleAnswer() {
        return permissibleAnswer;
    }
     ...
     */
    public void setPermissibleAnswer(gov.nih.nci.cabig.ccts.domain.StratificationCriterionPermissibleAnswerType[] permissibleAnswer) {
        this.permissibleAnswer = permissibleAnswer;
    }

    public gov.nih.nci.cabig.ccts.domain.StratificationCriterionPermissibleAnswerType getPermissibleAnswer(int i) {
        return this.permissibleAnswer[i];
    }

    public void setPermissibleAnswer(int i, gov.nih.nci.cabig.ccts.domain.StratificationCriterionPermissibleAnswerType _value) {
