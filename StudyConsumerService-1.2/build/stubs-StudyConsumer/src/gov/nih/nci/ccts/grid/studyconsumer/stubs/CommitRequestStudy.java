...
public class CommitRequestStudy  implements java.io.Serializable {
    private gov.nih.nci.cabig.ccts.domain.Study study;

    public CommitRequestStudy() {
    }
    ...
    /**
     * Gets the study value for this CommitRequestStudy.
     * 
     * @return study
     */
    ...
    /**
     * Sets the study value for this CommitRequestStudy.
     * 
     * @param study
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CommitRequestStudy)) return false;
        CommitRequestStudy other = (CommitRequestStudy) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CommitRequestStudy.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://studyconsumer.grid.ccts.nci.nih.gov/StudyConsumer", ">>CommitRequest>study"));
