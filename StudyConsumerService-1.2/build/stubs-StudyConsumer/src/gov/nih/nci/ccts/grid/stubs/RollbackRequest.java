...
public class RollbackRequest  implements java.io.Serializable {
    private gov.nih.nci.ccts.grid.stubs.RollbackRequestStudy study;

    public RollbackRequest() {
    }

    public RollbackRequest(
           gov.nih.nci.ccts.grid.stubs.RollbackRequestStudy study) {
           this.study = study;
    }
     ...
     * @return study
     */
    public gov.nih.nci.ccts.grid.stubs.RollbackRequestStudy getStudy() {
        return study;
    }
     ...
     * @param study
     */
    public void setStudy(gov.nih.nci.ccts.grid.stubs.RollbackRequestStudy study) {
        this.study = study;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://grid.ccts.nci.nih.gov/StudyConsumer", ">RollbackRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://grid.ccts.nci.nih.gov/StudyConsumer", ">>RollbackRequest>study"));
