...
public class StudyConsumerServiceLocator extends org.apache.axis.client.Service implements gov.nih.nci.ccts.grid.studyconsumer.stubs.service.StudyConsumerService {
    ...
    public gov.nih.nci.ccts.grid.studyconsumer.stubs.StudyConsumerPortType getStudyConsumerPortTypePort() throws javax.xml.rpc.ServiceException {
    ...
    public gov.nih.nci.ccts.grid.studyconsumer.stubs.StudyConsumerPortType getStudyConsumerPortTypePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            gov.nih.nci.ccts.grid.studyconsumer.stubs.bindings.StudyConsumerPortTypeSOAPBindingStub _stub = new gov.nih.nci.ccts.grid.studyconsumer.stubs.bindings.StudyConsumerPortTypeSOAPBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (gov.nih.nci.ccts.grid.studyconsumer.stubs.StudyConsumerPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                gov.nih.nci.ccts.grid.studyconsumer.stubs.bindings.StudyConsumerPortTypeSOAPBindingStub _stub = new gov.nih.nci.ccts.grid.studyconsumer.stubs.bindings.StudyConsumerPortTypeSOAPBindingStub(new java.net.URL(StudyConsumerPortTypePort_address), this);
                _stub.setPortName(getStudyConsumerPortTypePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://studyconsumer.grid.ccts.nci.nih.gov/StudyConsumer/service", "StudyConsumerService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://studyconsumer.grid.ccts.nci.nih.gov/StudyConsumer/service", "StudyConsumerPortTypePort"));
        }
