...
public abstract class StudyOrganizationType  implements java.io.Serializable {
    private gov.nih.nci.ccts.grid.HealthcareSiteType[] healthcareSite;
    private gov.nih.nci.ccts.grid.StudyInvestigatorType[] studyInvestigator;
    ...
    public StudyOrganizationType(
           ...
           gov.nih.nci.ccts.grid.HealthcareSiteType[] healthcareSite,
           gov.nih.nci.ccts.grid.StudyInvestigatorType[] studyInvestigator) {
     ...
     */
    public gov.nih.nci.ccts.grid.HealthcareSiteType[] getHealthcareSite() {
        return healthcareSite;
    }
     ...
     */
    public void setHealthcareSite(gov.nih.nci.ccts.grid.HealthcareSiteType[] healthcareSite) {
        this.healthcareSite = healthcareSite;
    }

    public gov.nih.nci.ccts.grid.HealthcareSiteType getHealthcareSite(int i) {
        return this.healthcareSite[i];
    }

    public void setHealthcareSite(int i, gov.nih.nci.ccts.grid.HealthcareSiteType _value) {
     ...
     */
    public gov.nih.nci.ccts.grid.StudyInvestigatorType[] getStudyInvestigator() {
        return studyInvestigator;
    }
     ...
     */
    public void setStudyInvestigator(gov.nih.nci.ccts.grid.StudyInvestigatorType[] studyInvestigator) {
        this.studyInvestigator = studyInvestigator;
    }

    public gov.nih.nci.ccts.grid.StudyInvestigatorType getStudyInvestigator(int i) {
        return this.studyInvestigator[i];
    }

    public void setStudyInvestigator(int i, gov.nih.nci.ccts.grid.StudyInvestigatorType _value) {
