...
public class CreateStudyRequest  implements java.io.Serializable {
    private gov.nih.nci.ccts.grid.studyconsumer.stubs.CreateStudyRequestStudy study;

    public CreateStudyRequest() {
    }

    public CreateStudyRequest(
           gov.nih.nci.ccts.grid.studyconsumer.stubs.CreateStudyRequestStudy study) {
           this.study = study;
    }
     ...
     * @return study
     */
    public gov.nih.nci.ccts.grid.studyconsumer.stubs.CreateStudyRequestStudy getStudy() {
        return study;
    }
     ...
     * @param study
     */
    public void setStudy(gov.nih.nci.ccts.grid.studyconsumer.stubs.CreateStudyRequestStudy study) {
        this.study = study;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://studyconsumer.grid.ccts.nci.nih.gov/StudyConsumer", ">CreateStudyRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://studyconsumer.grid.ccts.nci.nih.gov/StudyConsumer", ">>CreateStudyRequest>study"));
