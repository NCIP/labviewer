...
public class RollbackRequestStudy  implements java.io.Serializable {
    private gov.nih.nci.cabig.ccts.domain.Study study;

    public RollbackRequestStudy() {
    }
    ...
    /**
     * Gets the study value for this RollbackRequestStudy.
     * 
     * @return study
     */
    ...
    /**
     * Sets the study value for this RollbackRequestStudy.
     * 
     * @param study
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RollbackRequestStudy)) return false;
        RollbackRequestStudy other = (RollbackRequestStudy) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RollbackRequestStudy.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://studyconsumer.grid.ccts.nci.nih.gov/StudyConsumer", ">>RollbackRequest>study"));
