/**
 * StudyConsumerReference.java
 *
 * This file was auto-generated from WSDL
 * by the Apache Axis 1.2RC2 Apr 28, 2006 (12:42:00 EDT) WSDL2Java emitter.
 */

package gov.nih.nci.ccts.grid.studyconsumer.stubs.types;

public class StudyConsumerReference  implements java.io.Serializable {
    private org.apache.axis.message.addressing.EndpointReferenceType endpointReference;

    public StudyConsumerReference() {
    }
    ...
    /**
     * Gets the endpointReference value for this StudyConsumerReference.
     * 
    ...
    /**
     * Sets the endpointReference value for this StudyConsumerReference.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof StudyConsumerReference)) return false;
        StudyConsumerReference other = (StudyConsumerReference) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(StudyConsumerReference.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://studyconsumer.grid.ccts.nci.nih.gov/StudyConsumer/types", ">StudyConsumerReference"));
