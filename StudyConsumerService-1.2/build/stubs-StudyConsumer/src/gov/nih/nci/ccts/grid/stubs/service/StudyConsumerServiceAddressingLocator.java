...
public class StudyConsumerServiceAddressingLocator extends gov.nih.nci.ccts.grid.stubs.service.StudyConsumerServiceLocator implements gov.nih.nci.ccts.grid.stubs.service.StudyConsumerServiceAddressing {
    public gov.nih.nci.ccts.grid.stubs.StudyConsumerPortType getStudyConsumerPortTypePort(org.apache.axis.message.addressing.EndpointReferenceType reference) throws javax.xml.rpc.ServiceException {
	...
	gov.nih.nci.ccts.grid.stubs.StudyConsumerPortType _stub = getStudyConsumerPortTypePort(endpoint);
	if (_stub != null) {
