 ...
 */
public abstract class RegistrationConsumerClientBase extends ServiceSecurityClient {	
	...
	public RegistrationConsumerClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public RegistrationConsumerClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected RegistrationConsumerPortType createPortType() throws RemoteException {
