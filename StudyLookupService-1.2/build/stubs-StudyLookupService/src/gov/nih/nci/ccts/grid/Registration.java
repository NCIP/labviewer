...
public class Registration  implements java.io.Serializable {
    private gov.nih.nci.ccts.grid.StudySiteType studySite;
    private gov.nih.nci.ccts.grid.StudyRefType studyRef;
    private gov.nih.nci.ccts.grid.ParticipantType participant;
    ...
    private gov.nih.nci.ccts.grid.RegDataEntryStatusType regDataEntryStatus;
    private gov.nih.nci.ccts.grid.RegWorkflowStatusType regWorkflowStatus;
    private gov.nih.nci.ccts.grid.ScheduledEpochType scheduledEpoch;
    ...
    public Registration(
           ...
           gov.nih.nci.ccts.grid.ParticipantType participant,
           gov.nih.nci.ccts.grid.RegDataEntryStatusType regDataEntryStatus,
           gov.nih.nci.ccts.grid.RegWorkflowStatusType regWorkflowStatus,
           gov.nih.nci.ccts.grid.ScheduledEpochType scheduledEpoch,
           java.util.Date startDate,
           java.lang.String stratumGroup,
           gov.nih.nci.ccts.grid.StudyRefType studyRef,
           gov.nih.nci.ccts.grid.StudySiteType studySite) {
     ...
     * @return studySite
     */
    public gov.nih.nci.ccts.grid.StudySiteType getStudySite() {
        return studySite;
    }
     ...
     * @param studySite
     */
    public void setStudySite(gov.nih.nci.ccts.grid.StudySiteType studySite) {
        this.studySite = studySite;
    }
     ...
     * @return studyRef
     */
    public gov.nih.nci.ccts.grid.StudyRefType getStudyRef() {
        return studyRef;
    }
     ...
     * @param studyRef
     */
    public void setStudyRef(gov.nih.nci.ccts.grid.StudyRefType studyRef) {
        this.studyRef = studyRef;
    }
     ...
     * @return participant
     */
    public gov.nih.nci.ccts.grid.ParticipantType getParticipant() {
        return participant;
    }
     ...
     * @param participant
     */
    public void setParticipant(gov.nih.nci.ccts.grid.ParticipantType participant) {
        this.participant = participant;
    }
     ...
     */
    public gov.nih.nci.ccts.grid.RegDataEntryStatusType getRegDataEntryStatus() {
        return regDataEntryStatus;
    }
     ...
     */
    public void setRegDataEntryStatus(gov.nih.nci.ccts.grid.RegDataEntryStatusType regDataEntryStatus) {
        this.regDataEntryStatus = regDataEntryStatus;
    }
     ...
     */
    public gov.nih.nci.ccts.grid.RegWorkflowStatusType getRegWorkflowStatus() {
        return regWorkflowStatus;
    }
     ...
     */
    public void setRegWorkflowStatus(gov.nih.nci.ccts.grid.RegWorkflowStatusType regWorkflowStatus) {
        this.regWorkflowStatus = regWorkflowStatus;
    }
     ...
     */
    public gov.nih.nci.ccts.grid.ScheduledEpochType getScheduledEpoch() {
        return scheduledEpoch;
    }
     ...
     */
    public void setScheduledEpoch(gov.nih.nci.ccts.grid.ScheduledEpochType scheduledEpoch) {
        this.scheduledEpoch = scheduledEpoch;
    }
