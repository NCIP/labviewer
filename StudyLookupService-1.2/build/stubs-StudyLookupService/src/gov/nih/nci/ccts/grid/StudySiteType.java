...
public class StudySiteType  extends gov.nih.nci.ccts.grid.StudyOrganizationType  implements java.io.Serializable {
    private java.util.Date irbApprovalDate;
    private java.lang.String roleCode;
    private java.util.Date startDate;
    private gov.nih.nci.ccts.grid.SiteStudyStatusType siteStudyStatus;
    ...
    public StudySiteType(
           ...
           gov.nih.nci.ccts.grid.SiteStudyStatusType siteStudyStatus,
     ...
     */
    public gov.nih.nci.ccts.grid.SiteStudyStatusType getSiteStudyStatus() {
        return siteStudyStatus;
    }
     ...
     */
    public void setSiteStudyStatus(gov.nih.nci.ccts.grid.SiteStudyStatusType siteStudyStatus) {
        this.siteStudyStatus = siteStudyStatus;
    }
