...
import gov.nih.nci.cagrid.labviewer.grid.service.globus.StudyLookupServiceAuthorization;
...
public class StudyLookupServiceImpl extends StudyLookupServiceImplBase {
  ...
  public gov.nih.nci.ccts.grid.Study getStudy(gov.nih.nci.ccts.grid.Registration registration) throws RemoteException {
		...
		/*// Authorization code : note No Specific exception for StudyLookup
		String username = StudyLookupServiceAuthorization.getCallerIdentity();
