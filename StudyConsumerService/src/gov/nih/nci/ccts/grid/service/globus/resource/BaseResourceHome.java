...
public class BaseResourceHome extends SingletonResourceHome implements Initializable {
	...
	public StudyConsumerResource getResource(){
		StudyConsumerResource serviceBaseResource;
		try {
			serviceBaseResource = (StudyConsumerResource)ResourceContext.getResourceContext().getResource();
