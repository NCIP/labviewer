 ...
 * 
 */
public class RegistrationConsumerAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://grid.ccts.nci.nih.gov/RegistrationConsumer";
	
	Map authorizationClassMap = new HashMap();
	
	
	public RegistrationConsumerAuthorization() {
	}
	...
	public void authorizeRegister(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getServiceSecurityMetadata")){
			...
			authorizeRegister(peerSubject, context, operation);
			return true;
