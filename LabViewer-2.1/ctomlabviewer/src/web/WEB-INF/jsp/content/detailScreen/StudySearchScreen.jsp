						...
						<div class="background-L">
							<div class="background-R">
								<h2>
									...
									[
									<bean:write name="StudySearchForm" property="listSize" />
									Record(s) found]
								</h2>
							</div>
						</div>
																			...
																			<tr>
																				<td>
																					<table summary="Enter summary of data here"
																						...
																						id="myScrollTable" class="dataTable sortable"
																						...
																						<tbody>
																							<nested:iterate name="StudySearchForm"
																								id="studiesList" property="studiesList"
																								type="gov.nih.nci.caxchange.ctom.viewer.viewobjects.StudySearchResult"
																								indexId="iterateId">
																								<tr>
																									<td class="dataCellText" width="15%">
																										&nbsp;
																										<a href="#"
																											onClick="loadParticipant(${iterateId})"><nested:write
																												name="studiesList" property="studyId" /> </a>
																									</td>
																									<td class="dataCellText" width="15%">
																										&nbsp;
																										<nested:write name="studiesList"
																											property="shortTitle" />
																									</td>
																									<td class="dataCellText" width="15%">
																										&nbsp;
																										<nested:write name="studiesList"
																											property="sponsorCode" />
																									</td>
																									<td class="dataCellText" width="15%">
																										&nbsp;
																										<nested:write name="studiesList"
																									...
																									<td class="dataCellText" width="15%">
																										<a href="#"
																											onClick="showHealthCareSite(${iterateId})">Details</a>
																									</td>
																									<td class="dataCellText" width="15%">
																										<a href="#" onClick="showPI(${iterateId})">Details</a>
																									</td>
																									<nested:hidden name="studiesList"
																										property="index" indexed="true" />
																								</tr>
																							</nested:iterate>
																						</tbody>
																					</table>
