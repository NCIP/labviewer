 ...
 */
public abstract class StudyLookupServiceClientBase extends ServiceSecurityClient {	
	...
	public StudyLookupServiceClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public StudyLookupServiceClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected StudyLookupServicePortType createPortType() throws RemoteException {
