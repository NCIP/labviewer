 ...
 */
public abstract class StudyConsumerClientBase extends ServiceSecurityClient {	
	...
	public StudyConsumerClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public StudyConsumerClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected StudyConsumerPortType createPortType() throws RemoteException {
