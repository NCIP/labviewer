...
public class HealthcareSiteInvestigatorType  implements java.io.Serializable {
    private gov.nih.nci.cabig.ccts.domain.InvestigatorType[] investigator;

    public HealthcareSiteInvestigatorType() {
    }

    public HealthcareSiteInvestigatorType(
           gov.nih.nci.cabig.ccts.domain.InvestigatorType[] investigator) {
     ...
     * @return investigator
     */
    public gov.nih.nci.cabig.ccts.domain.InvestigatorType[] getInvestigator() {
        return investigator;
    }
     ...
     * @param investigator
     */
    public void setInvestigator(gov.nih.nci.cabig.ccts.domain.InvestigatorType[] investigator) {
        this.investigator = investigator;
    }

    public gov.nih.nci.cabig.ccts.domain.InvestigatorType getInvestigator(int i) {
        return this.investigator[i];
    }

    public void setInvestigator(int i, gov.nih.nci.cabig.ccts.domain.InvestigatorType _value) {
