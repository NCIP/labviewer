...
public class StudyDiseaseType  implements java.io.Serializable {
    ...
    private gov.nih.nci.cabig.ccts.domain.DiseaseTermType[] diseaseTerm;
    ...
    public StudyDiseaseType(
           gov.nih.nci.cabig.ccts.domain.DiseaseTermType[] diseaseTerm,
     ...
     * @return diseaseTerm
     */
    public gov.nih.nci.cabig.ccts.domain.DiseaseTermType[] getDiseaseTerm() {
        return diseaseTerm;
    }
     ...
     * @param diseaseTerm
     */
    public void setDiseaseTerm(gov.nih.nci.cabig.ccts.domain.DiseaseTermType[] diseaseTerm) {
        this.diseaseTerm = diseaseTerm;
    }

    public gov.nih.nci.cabig.ccts.domain.DiseaseTermType getDiseaseTerm(int i) {
        return this.diseaseTerm[i];
    }

    public void setDiseaseTerm(int i, gov.nih.nci.cabig.ccts.domain.DiseaseTermType _value) {
