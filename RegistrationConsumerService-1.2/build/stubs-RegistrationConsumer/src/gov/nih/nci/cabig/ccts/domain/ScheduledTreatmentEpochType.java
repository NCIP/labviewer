...
public class ScheduledTreatmentEpochType  extends gov.nih.nci.cabig.ccts.domain.ScheduledEpochType  implements java.io.Serializable {
    private gov.nih.nci.cabig.ccts.domain.ScheduledArmType scheduledArm;
    ...
    public ScheduledTreatmentEpochType(
           ...
           gov.nih.nci.cabig.ccts.domain.ScheduledArmType scheduledArm) {
     ...
     * @return scheduledArm
     */
    public gov.nih.nci.cabig.ccts.domain.ScheduledArmType getScheduledArm() {
        return scheduledArm;
    }
     ...
     * @param scheduledArm
     */
    public void setScheduledArm(gov.nih.nci.cabig.ccts.domain.ScheduledArmType scheduledArm) {
        this.scheduledArm = scheduledArm;
    }
