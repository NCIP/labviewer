/**
 * RollbackRequestRegistration.java
 *
...
public class RollbackRequestRegistration  implements java.io.Serializable {
    private gov.nih.nci.ccts.grid.Registration registration;

    public RollbackRequestRegistration() {
    }
    ...
    /**
     * Gets the registration value for this RollbackRequestRegistration.
     * 
     * @return registration
     */
    ...
    /**
     * Sets the registration value for this RollbackRequestRegistration.
     * 
     * @param registration
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RollbackRequestRegistration)) return false;
        RollbackRequestRegistration other = (RollbackRequestRegistration) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RollbackRequestRegistration.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://grid.ccts.nci.nih.gov/RegistrationConsumer", ">>RollbackRequest>registration"));
