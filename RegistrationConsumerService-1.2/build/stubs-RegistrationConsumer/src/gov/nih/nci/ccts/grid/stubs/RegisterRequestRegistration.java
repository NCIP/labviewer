/**
 * RegisterRequestRegistration.java
 *
...
public class RegisterRequestRegistration  implements java.io.Serializable {
    private gov.nih.nci.cabig.ccts.domain.Registration registration;

    public RegisterRequestRegistration() {
    }
    ...
    /**
     * Gets the registration value for this RegisterRequestRegistration.
     * 
     * @return registration
     */
    ...
    /**
     * Sets the registration value for this RegisterRequestRegistration.
     * 
     * @param registration
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RegisterRequestRegistration)) return false;
        RegisterRequestRegistration other = (RegisterRequestRegistration) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RegisterRequestRegistration.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://grid.ccts.nci.nih.gov/RegistrationConsumer", ">>RegisterRequest>registration"));
