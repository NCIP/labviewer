 ...
 * 
 */
public class LabLoaderAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://labviewer.cagrid.nci.nih.gov/LabLoader";
	
	Map authorizationClassMap = new HashMap();
	
	
	public LabLoaderAuthorization() {
	}
	...
	public void authorizeLoadLab(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getServiceSecurityMetadata")){
			...
			return true;
		} else if(operation.getLocalPart().equals("loadLab")){
			authorizeLoadLab(peerSubject, context, operation);
			return true;
