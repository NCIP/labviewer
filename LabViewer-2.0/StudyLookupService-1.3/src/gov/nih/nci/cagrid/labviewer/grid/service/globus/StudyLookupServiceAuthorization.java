 ...
 * 
 */
public class StudyLookupServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://grid.labviewer.cagrid.nci.nih.gov/StudyLookupService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public StudyLookupServiceAuthorization() {
	}
	...
	public void authorizeGetStudy(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getServiceSecurityMetadata")){
			...
			authorizeGetStudy(peerSubject, context, operation);
			return true;
		} 		
		return false;
	}
