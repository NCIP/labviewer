...
<%@ taglib uri="http://jakarta.apache.org/struts/tags-nested"
	prefix="nested"%>
<%@ page import="gov.nih.nci.caxchange.ctom.viewer.forms.PIForm"%>
																		...
																		<tr>
																			<td>
																				<table summary="Enter summary of data here"
																					...
																					<tbody>
																						<nested:iterate name="PIForm"
																							id="piList" property="piList"
																							type="gov.nih.nci.caxchange.ctom.viewer.beans.PrincipalInvestigator"
																							indexId="iterateId">
																							<tr>
