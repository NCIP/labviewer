 ...
 * 
 */
public class StudyConsumerAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://studyconsumer.grid.ccts.nci.nih.gov/StudyConsumer";
	
	Map authorizationClassMap = new HashMap();
	
	
	public StudyConsumerAuthorization() {
	}
	...
	public void authorizeCreateStudy(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getServiceSecurityMetadata")){
			...
			authorizeCreateStudy(peerSubject, context, operation);
			return true;
