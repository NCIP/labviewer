...
import gov.nih.nci.cagrid.labviewer.grid.common.StudyServiceConstants;
import gov.nih.nci.cagrid.labviewer.grid.stubs.StudyServiceResourceProperties;
 ...
 * 
 */
public class StudyServiceResourceHome extends SingletonResourceHomeImpl implements Initializable {

	static final Log logger = LogFactory.getLog(StudyServiceResourceHome.class);
    private static final UUIDGen UUIDGEN = UUIDGenFactory.getUUIDGen();

	public Resource createSingleton() {
		logger.info("Creating a single resource.");
		try {
		    StudyServiceResourceProperties props = new StudyServiceResourceProperties();
			StudyServiceResource resource = new StudyServiceResource();
			if (resource instanceof PersistenceCallback) {
                  ...
                  try{
                    ((PersistenceCallback) resource).load(null);
			          ...
			          resource.initialize(props, StudyServiceConstants.RESOURCE_PROPERTY_SET, UUIDGEN.nextUUID());
			      }
            } else {
                    resource.initialize(props, StudyServiceConstants.RESOURCE_PROPERTY_SET, UUIDGEN.nextUUID());
            }
	...
	public Resource find(ResourceKey key) throws ResourceException {
		StudyServiceResource resource = (StudyServiceResource) super.find(key);
		return resource;
	}
     ...
     */
    public StudyServiceResource getAddressedResource() throws Exception {
        StudyServiceResource thisResource;
        thisResource = (StudyServiceResource) ResourceContext.getResourceContext().getResource();
        return thisResource;
    }
}