...
import gov.nih.nci.cagrid.labviewer.grid.service.StudyLookupServiceConfiguration;
import java.io.File;
 ...
 * 
 */
public abstract class StudyLookupServiceResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(StudyLookupServiceResourceBase.class);

	private StudyLookupServiceResourceConfiguration configuration;
    ...
    public StudyLookupServiceResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((StudyLookupServiceResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(StudyLookupServiceConstants.SERVICEMETADATA);
	...
	public StudyLookupServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/StudyLookupService";
		...
		try {
			...
			this.configuration = (StudyLookupServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((StudyLookupServiceResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
