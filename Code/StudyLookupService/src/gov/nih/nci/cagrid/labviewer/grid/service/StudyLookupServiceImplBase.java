...
import gov.nih.nci.cagrid.labviewer.grid.service.ServiceConfiguration;
...
public abstract class StudyLookupServiceImplBase {
	...
	public gov.nih.nci.cagrid.labviewer.grid.service.globus.resource.BaseResourceHome getResourceHome() throws Exception {
		ResourceHome resource = getResourceHome("home");
		return (gov.nih.nci.cagrid.labviewer.grid.service.globus.resource.BaseResourceHome)resource;
	}
	...
	protected Object getMetadata(QName metadataQName) {
		StudyLookupServiceResource serviceBaseResource = null;
		try {
			serviceBaseResource = (StudyLookupServiceResource) ResourceContext.getResourceContext().getResource();
		} catch (ResourceContextException e) {
			return null;
