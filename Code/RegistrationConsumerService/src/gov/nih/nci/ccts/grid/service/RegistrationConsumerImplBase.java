...
public abstract class RegistrationConsumerImplBase {
	...
	protected gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadataValue(){
		RegistrationConsumerResource serviceBaseResource;
		try {
			serviceBaseResource = (RegistrationConsumerResource)ResourceContext.getResourceContext().getResource();
	...
	protected Object getMetadata(QName metadataQName) {
		RegistrationConsumerResource serviceBaseResource = null;
		try {
			serviceBaseResource = (RegistrationConsumerResource) ResourceContext.getResourceContext().getResource();
		} catch (ResourceContextException e) {
			return null;
