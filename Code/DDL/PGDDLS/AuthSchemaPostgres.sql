...
DROP TABLE IF EXISTS CSM_USER_PE CASCADE;
	...
	CREATE OR REPLACE FUNCTION SET_CSM_PG_PE_PG_PE_ID() RETURNS trigger AS $SET_CSM_PG_PE_PG_PE_ID$
	    BEGIN
	...
	CREATE OR REPLACE FUNCTION SET_CSM_PG_PE_UPDATE_DATE() RETURNS trigger AS $SET_CSM_PG_PE_UPDATE_DATE$
	    BEGIN
	...
	CREATE OR REPLACE FUNCTION SET_CSM_ROLE_PRIV_ROLE_PRIVILE() RETURNS trigger AS $SET_CSM_ROLE_PRIV_ROLE_PRIVILE$
	    BEGIN
	...
	CREATE OR REPLACE FUNCTION SET_CSM_ROLE_PRIV_UPDATE_DATE() RETURNS trigger AS $SET_CSM_ROLE_PRIV_UPDATE_DATE$
	    BEGIN
		NEW.update_date := current_date;
		RETURN NEW;
	    END;
	...
	CREATE OR REPLACE FUNCTION SET_CSM_USER_GROU_USER_GROUP_I() RETURNS trigger AS $SET_CSM_USER_GROU_USER_GROUP_I$
	    BEGIN
	...
	CREATE OR REPLACE FUNCTION SET_CSM_USER_PE_USER_PROTECTIO() RETURNS trigger AS $SET_CSM_USER_PE_USER_PROTECTIO$
	    BEGIN
	...
	CREATE OR REPLACE FUNCTION SET_CSM_USER_PE_UPDATE_DATE() RETURNS trigger AS $SET_CSM_USER_PE_UPDATE_DATE$
	    BEGIN
		NEW.UPDATE_DATE := current_date;
		RETURN NEW;
	    END;
