...
import gov.nih.nci.cagrid.labviewer.service.globus.resource.LabLoaderResource;
import gov.nih.nci.cagrid.labviewer.service.ServiceConfiguration;
 ...
 * 
 */
public abstract class LabLoaderImplBase {
	
	public LabLoaderImplBase() throws RemoteException {
	...
	public gov.nih.nci.cagrid.labviewer.service.globus.resource.BaseResourceHome getResourceHome() throws Exception {
		ResourceHome resource = getResourceHome("home");
		return (gov.nih.nci.cagrid.labviewer.service.globus.resource.BaseResourceHome)resource;
	}
	...
	protected gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadataValue(){
		LabLoaderResource serviceBaseResource;
		try {
			serviceBaseResource = (LabLoaderResource)ResourceContext.getResourceContext().getResource();
	...
	protected Object getMetadata(QName metadataQName) {
		LabLoaderResource serviceBaseResource = null;
		try {
			serviceBaseResource = (LabLoaderResource) ResourceContext.getResourceContext().getResource();
		} catch (ResourceContextException e) {
			return null;
