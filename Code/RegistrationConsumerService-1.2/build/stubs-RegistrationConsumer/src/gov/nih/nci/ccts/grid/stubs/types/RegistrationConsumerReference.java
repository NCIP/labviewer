/**
 * RegistrationConsumerReference.java
 *
...
public class RegistrationConsumerReference  implements java.io.Serializable {
    private org.apache.axis.message.addressing.EndpointReferenceType endpointReference;

    public RegistrationConsumerReference() {
    }
    ...
    /**
     * Gets the endpointReference value for this RegistrationConsumerReference.
     * 
    ...
    /**
     * Sets the endpointReference value for this RegistrationConsumerReference.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RegistrationConsumerReference)) return false;
        RegistrationConsumerReference other = (RegistrationConsumerReference) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RegistrationConsumerReference.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://grid.ccts.nci.nih.gov/RegistrationConsumer/types", ">RegistrationConsumerReference"));
