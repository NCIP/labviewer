...
public class RegisterResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the registration value for this RegisterResponse.
     * 
     * @return registration
     */
    ...
    /**
     * Sets the registration value for this RegisterResponse.
     * 
     * @param registration
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://grid.ccts.nci.nih.gov/RegistrationConsumer", ">RegisterResponse"));
