package gov.nih.nci.cagrid.coppa.person.service.service.globus.resource;
...
import gov.nih.nci.cagrid.coppa.person.service.common.CoppaPersonServiceConstants;
import gov.nih.nci.cagrid.coppa.person.service.stubs.CoppaPersonServiceResourceProperties;
 ...
 * 
 */
public abstract class CoppaPersonServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(CoppaPersonServiceResourceBase.class);

	private CoppaPersonServiceResourceConfiguration configuration;
    ...
    public CoppaPersonServiceResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((CoppaPersonServiceResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(CoppaPersonServiceConstants.SERVICEMETADATA);
	...
	public CoppaPersonServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/CoppaPersonService";
		...
		try {
			...
			this.configuration = (CoppaPersonServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((CoppaPersonServiceResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
