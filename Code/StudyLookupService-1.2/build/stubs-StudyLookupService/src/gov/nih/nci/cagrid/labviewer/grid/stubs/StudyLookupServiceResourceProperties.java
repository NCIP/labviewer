/**
 * StudyLookupServiceResourceProperties.java
 *
...
public class StudyLookupServiceResourceProperties  implements java.io.Serializable {
    private gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata;

    public StudyLookupServiceResourceProperties() {
    }
    ...
    /**
     * Gets the serviceMetadata value for this StudyLookupServiceResourceProperties.
     * 
    ...
    /**
     * Sets the serviceMetadata value for this StudyLookupServiceResourceProperties.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof StudyLookupServiceResourceProperties)) return false;
        StudyLookupServiceResourceProperties other = (StudyLookupServiceResourceProperties) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(StudyLookupServiceResourceProperties.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://grid.labviewer.cagrid.nci.nih.gov/StudyLookupService", ">StudyLookupServiceResourceProperties"));
