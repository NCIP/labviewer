...
INSERT INTO `CAXCHANGE_MESSAGE_TYPES`(`MESSAGE_TYPE`,`PAYLOAD_NAMESPACE`) VALUES('STUDY_CREATION','ccts.cabig/1.0/gov.nih.nci.cabig.ccts.domain'),('REGISTER_SUBJECT','ccts.cabig/1.0/gov.nih.nci.cabig.ccts.domain');
